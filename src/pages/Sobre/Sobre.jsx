import { ContainerSection } from "../../pages/Tecnologias/styled";
    ...
    <>
      ...
      <ContainerSobre>
        <ContainerSection>
          ...
          <Texto>
            Desenvolvedora Front-End em formação pelo bootcamp de
            Desenvolvimento Web Full Stack da Labenu. As principais tecnologias
            que utilizo são Javascript, CSS e ReactJS. Tenho formação em
            Arquitetura e Urbanismo, e possuo experiência em desenvolvimento de
            treinamentos para equipes, gerenciamento de equipe e escritório,
            produção de artes gráficas, compras, administrativo, financeiro e
            licitações.
          </Texto>
        </ContainerSection>
        <ContainerSection>
          ...
          <Cargo
            ...
            info={
              "Desenvolvi e ministrei um treinamento de software de renderização para implementação no escritório, fui responsável pela compatibilização das etapas de projeto no software Archicad. Contato com clientes, gerenciamento e mentoria em tecnologia para equipe de estagiários."
            }
          />
          <Cargo
            cargo={"Designer"}
            ...
            info={
              "Fiz parte da equipe vencedora do Prêmio OURO Bornancini 2020, em design de ambientes Produção de peças gráficas de design, apresentação para clientes e arte final para impressão"
            }
          />
          <Cargo
